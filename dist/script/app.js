...
app.config(['$stateProvider', '$urlRouterProvider',
    function ($stateProvider, $urlRouterProvider) {
        ...
        $stateProvider.state('index', {
            url: '/index',
            templateUrl: '/ng_unit/ng_view/ng_index/index_content.html',
            onEnter: function () {
            ...
            state('dance', {
                url: '/dance?id',
                templateUrl: '/ng_unit/ng_view/ng_index/dance_content.html',
            ...
            state('music', {
                url: '/music?id',
                templateUrl: '/ng_unit/ng_view/ng_index/music_content.html',
                onEnter: function () {
            ...
            state('lang', {
                url: '/lang?id',
                templateUrl: '/ng_unit/ng_view/ng_index/lang_content.html',
                onEnter: function () {
            ...
            state('hotTopic', {
                url: '/hotTopic',
                templateUrl: '/ng_unit/ng_view/ng_index/hotTopic_content.html',
                onEnter: function () {
            ...
            state('contentDetail', {
                url: '/contentDetail',
                templateUrl: '/ng_unit/ng_view/ng_index/contentDetail.html'
            }).
            state('topic', {
                url: '/topic',
                templateUrl: '/ng_unit/ng_view/ng_index/topicDetail.html'
            }).
            state('self', {
                url: '/self?type&role',
                templateUrl: '/ng_unit/ng_view/ng_index/selfDetail.html',
